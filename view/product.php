...
<html lang="en">
                    ...
                    <div class="dis-none panel-filter w-full p-t-10">
                        <div class="wrap-filter flex-w bg6 w-full p-lr-40 p-t-27 p-lr-15-sm">
                            <div class="filter-col1 p-r-15 p-b-27">
                                ...
                                <ul>
                                    <li class="p-b-6">
                                        <a href="../categories/novels.php" class="filter-link stext-106 trans-04">
                                          Novels
                                        </a>
                                    </li>

                                    <li class="p-b-6">
                                        <a href="../categories/science.php" class="filter-link stext-106 trans-04">
                                            Science
                                        </a>
                                    </li>

                                    <li class="p-b-6">
                                        <a href="../categories/maths.php" class="filter-link stext-106 trans-04">
                                           Mathematics
                                        </a>
                                    </li>

                                    <li class="p-b-6">
                                        <a href="../categories/history.php" class="filter-link stext-106 trans-04 filter-link-active">
                                           History
                                        </a>
                                    </li>

                                    <li class="p-b-6">
                                        <a href="../categories/self-help.php" class="filter-link stext-106 trans-04">
                                           Self-Help
                                        </a>
                                    </li>

                                    <li class="p-b-6">
                                        <a href="../categories/children.php" class="filter-link stext-106 trans-04">
                                          Children
                                        </a>
                                    </li>
                                </ul>
                            ...
                            <div class="filter-col2 p-r-15 p-b-27">
                                ...
                                <ul>
                                    ...
                                    <li class="p-b-6">
                                        <a href="less.php" class="filter-link stext-106 trans-04">
                                            GHS0.00 - GHS50.00
                                        </a>
                                    </li>
    ...
    <!--===============================================================================================-->
        ...
        <!-- CHECKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKK -->
