...
<body>
    ...
    <div class="container-xxl py-6">
        <div class="container">
            <div class="section-header text-center mx-auto mb-5 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 500px;">
                ...
                <p>We are available from 9am to 7pm everyweek day. And available on Saturdays from 1pm to 7pm.</p>
            </div>
            <div class="row g-5 justify-content-center">
                ...
                <div class="col-lg-7 col-md-12 wow fadeInUp" data-wow-delay="0.5s">
                    ...
                    <form method="post" action="../actions/send-email.php" onsubmit="return validateForm()"> 
                        <div class="row g-3">
                            <div class="col-md-6">
                            ...
                            <div class="col-12">
                                <button class="btn btn-primary rounded-pill py-3 px-5" name="sumbit" type="submit">Send Message</button>
                            </div>
                        </div>
                    </form>
    ...
    <script>
        ...
        var subject = document.getElementById("suject").value;
